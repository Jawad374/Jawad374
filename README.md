<h1 align="center">Hello there <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35">, I'm <span style="font-weight: bold; color: #3498db; animation: fadeIn 2s;">Muhammad Jawad Anjum a <span style="font-weight: bold; color: #e74c3c; animation: fadeIn 3s;"></span>Full Stack Web Developer </span></h1>

## 🚀‍ About me

Hey 👋, I'm Muhammad Jawad Anjum, a Full Stack Web Developer and BSCS graduate from Air University, Islamabad. 

I specialize in MERN stack (MongoDB, Express, React, Node.js) and Next.js frameworks. With a keen interest in **data manipulation**, **automation**, and **cutting-edge technologies**, I create efficient and scalable applications.
